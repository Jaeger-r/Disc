...
template <> constexpr inline auto TCPKernel::qt_create_metaobjectdata<qt_meta_tag_ZN9TCPKernelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'signal_onlineusers'
        QtMocHelpers::SignalData<void(STRU_ONLINE_USERS_RS *)>(24, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 25, 2 },
        }}),
        // Signal 'signal_privatechat'
        QtMocHelpers::SignalData<void(STRU_PRIVATE_CHAT_RS *)>(26, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 27, 2 },
        }}),
        // Signal 'signal_privatehistory'
        QtMocHelpers::SignalData<void(STRU_PRIVATE_HISTORY_RS *)>(28, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 29, 2 },
        }}),
        // Signal 'signal_transfercontrol'
        QtMocHelpers::SignalData<void(STRU_TRANSFERCONTROL_RS *)>(30, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 31, 2 },
        }}),
...
void TCPKernel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 11: _t->signal_onlineusers((*reinterpret_cast<std::add_pointer_t<STRU_ONLINE_USERS_RS*>>(_a[1]))); break;
        case 12: _t->signal_privatechat((*reinterpret_cast<std::add_pointer_t<STRU_PRIVATE_CHAT_RS*>>(_a[1]))); break;
        case 13: _t->signal_privatehistory((*reinterpret_cast<std::add_pointer_t<STRU_PRIVATE_HISTORY_RS*>>(_a[1]))); break;
        case 14: _t->signal_transfercontrol((*reinterpret_cast<std::add_pointer_t<STRU_TRANSFERCONTROL_RS*>>(_a[1]))); break;
        case 15: _t->signal_connectionStateChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(STRU_CHAT_RS * )>(_a, &TCPKernel::signal_chat, 10))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(STRU_ONLINE_USERS_RS * )>(_a, &TCPKernel::signal_onlineusers, 11))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(STRU_PRIVATE_CHAT_RS * )>(_a, &TCPKernel::signal_privatechat, 12))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(STRU_PRIVATE_HISTORY_RS * )>(_a, &TCPKernel::signal_privatehistory, 13))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(STRU_TRANSFERCONTROL_RS * )>(_a, &TCPKernel::signal_transfercontrol, 14))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPKernel::*)(bool , const QString & )>(_a, &TCPKernel::signal_connectionStateChanged, 15))
            return;
    }
}
...
// SIGNAL 11
void TCPKernel::signal_onlineusers(STRU_ONLINE_USERS_RS * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 11, nullptr, _t1);
}

// SIGNAL 12
void TCPKernel::signal_privatechat(STRU_PRIVATE_CHAT_RS * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 12, nullptr, _t1);
}

// SIGNAL 13
void TCPKernel::signal_privatehistory(STRU_PRIVATE_HISTORY_RS * _t1)
{
