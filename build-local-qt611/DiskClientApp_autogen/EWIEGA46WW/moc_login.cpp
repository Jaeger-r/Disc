...
template <> constexpr inline auto Login::qt_create_metaobjectdata<qt_meta_tag_ZN5LoginE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'slot_register'
        QtMocHelpers::SlotData<void(STRU_REGISTER_RS *)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Slot 'slot_connectionStateChanged'
        QtMocHelpers::SlotData<void(bool, const QString &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slot_register((*reinterpret_cast<std::add_pointer_t<STRU_REGISTER_RS*>>(_a[1]))); break;
        case 2: _t->slot_connectionStateChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Login::*)()>(_a, &Login::loginRequested, 0))
            return;
    }
}
